...
CHARGE_SUBSTITUTION_MATRIX = {
    ...
    "D": {"target": "K", "rationale": "Negative->Positive: aspartate to lysine charge reversal"},
    "E": {"target": "R", "rationale": "Negative->Positive: glutamate to arginine charge reversal"},
