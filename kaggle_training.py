...
aav_model, aav_hist = train_aav(aav_data, device, num_epochs=50, batch_size=256)
plot_history(aav_hist, "AAV Tropism", "/kaggle/working/aav_loss.png")

lnp_model, lnp_hist = train_lnp(lnp_data, device, num_epochs=100, batch_size=16)
plot_history(lnp_hist, "LNP Delivery", "/kaggle/working/lnp_loss.png")

immune_model, immune_hist = train_immune(immune_data, device, num_epochs=50, batch_size=256)
